...
<main class="max-w-7xl mx-auto px-6 py-6 space-y-8">
  ...
  <nav aria-label="breadcrumb" class="text-xs text-muted">
    <ol class="flex items-center space-x-2">
      ...
      <li class="opacity-40">/</li>
      <li class="text-slate-800 font-semibold" aria-current="page">Import Data</li>
    </ol>
  </nav>
  ...
  <header class="space-y-2">
    ...
    <h1 class="text-3xl font-extrabold text-slate-800">Import Data Master</h1>
  ...
  <section class="bg-carbonSoft rounded-xl p-6 border border-carbon w-full transition-all duration-300">
    ...
    <form id="importForm" action="{{ route('products.import.excel') }}" method="POST" enctype="multipart/form-data" class="space-y-4 w-full">
      ...
      <h3 id="formTitle" class="text-lg font-bold text-slate-800">Import Produk</h3>
  ...
  <section class="bg-carbonSoft rounded-xl p-6 border border-carbon w-full">
    ...
    <div id="guide-product" class="overflow-x-auto rounded-lg border border-carbon">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-carbon/50">
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">product_code</code></td>
            <td class="px-4 py-3 text-silver">Kode unik produk / SKU.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">name</code></td>
            <td class="px-4 py-3 text-silver">Nama lengkap produk.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">packaging</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">current_stock</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">cost_price</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">price</code></td>
            <td class="px-4 py-3 text-silver">Harga Jual ke Distributor.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional (Def: 0)</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">min_lead_time</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">max_lead_time</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">batch_size</code></td>
    ...
    <div id="guide-material" class="overflow-x-auto rounded-lg border border-carbon hidden">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-carbon/50">
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">material_code</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">category_type</code></td>
            <td class="px-4 py-3 text-silver">Pilih: <strong>mass</strong>, <strong>volume</strong>, atau <strong>unit</strong>.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">unit</code></td>
            <td class="px-4 py-3 text-silver">Satuan Dasar / Terkecil (gram, ml, pcs).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">purchase_unit</code></td>
            <td class="px-4 py-3 text-silver">Satuan Beli / Kemasan (Sak, Galon, Box).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">packaging_size</code></td>
            <td class="px-4 py-3 text-silver">Isi per kemasan (Contoh: 25).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">packaging_unit</code></td>
            <td class="px-4 py-3 text-silver">Satuan dari isi kemasan (kg, liter).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">conversion_factor</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">price_per_unit</code></td>
          ...
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">safety_stock</code></td>
            <td class="px-4 py-3 text-silver">Batas aman stok minimum (Base Unit).</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">reorder_point</code></td>
    ...
    <div id="guide-partner" class="overflow-x-auto rounded-lg border border-carbon hidden">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-carbon/50">
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">company_name</code></td>
            <td class="px-4 py-3 text-silver">Nama Perusahaan.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">person_name</code></td>
            <td class="px-4 py-3 text-silver">Nama Kontak.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">phone</code></td>
            <td class="px-4 py-3 text-silver">Nomor Telepon.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">email</code></td>
            <td class="px-4 py-3 text-silver">Alamat Email.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">address</code></td>
            <td class="px-4 py-3 text-silver">Alamat Lengkap.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">type</code></td>
    ...
    <div id="guide-recipe" class="overflow-x-auto rounded-lg border border-carbon hidden">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-carbon/50">
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Kode</code></td>
            <td class="px-4 py-3 text-silver">Kode Produk Induk (Parent).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Material</code></td>
            <td class="px-4 py-3 text-silver">Nama Bahan Baku (Sesuai Master Material).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Qty</code></td>
    ...
    <div id="guide-sales-order" class="overflow-x-auto rounded-lg border border-carbon hidden">
      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-carbon/50">
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Kode SO</code></td>
            <td class="px-4 py-3 text-silver">Nomor Nota (SO-202X-XXX).</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Tanggal</code></td>
            <td class="px-4 py-3 text-silver">Tanggal Transaksi.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Distributor</code></td>
            <td class="px-4 py-3 text-silver">Nama Customer / Distributor.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Status</code></td>
            <td class="px-4 py-3 text-silver">draft / confirmed / shipped.</td>
            <td class="px-4 py-3"><span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Wajib</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Tanggal Pengiriman</code></td>
            <td class="px-4 py-3 text-silver">Tanggal barang dikirim.</td>
            <td class="px-4 py-3"><span class="text-xs border border-carbon text-muted px-2 py-0.5 rounded">Opsional</span></td>
          </tr>
          <tr>
            <td class="px-4 py-3"><code class="text-slate-800 bg-blackBase/30 px-2 py-1 rounded">Jatuh Tempo</code></td>
