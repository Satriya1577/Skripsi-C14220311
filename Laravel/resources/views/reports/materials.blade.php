      ...
      <table class="w-full text-sm">
        <thead class="bg-carbon text-xs uppercase tracking-wide">
          <tr>
            ...
            <th class="px-4 py-3 text-center text-black border-b border-carbonSoft">Satuan Beli</th>
          ...
          @forelse($reports as $report)
            <tr class="hover:bg-carbon transition-colors">
              ...
              <td class="px-4 py-3 text-center">
                <a href="{{ route('reports.materialChart', $report->material_id) }}" 
                  ...
                  title="View Material Movement Chart">
