  ...
  <section class="bg-carbonSoft rounded-xl p-6 border border-carbon">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div class="bg-carbon p-6 rounded-lg border border-carbonSoft relative overflow-hidden shadow-lg">
        ...
        <h3 class="text-3xl font-bold text-slate-800 mt-2 ">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</h3>
      ...
      <div class="bg-carbon p-6 rounded-lg border border-carbonSoft relative overflow-hidden shadow-lg">
        ...
        <h3 class="text-3xl font-bold text-slate-800 mt-2 ">Rp {{ number_format($totalCogs, 0, ',', '.') }}</h3>
      ...
      <table class="w-full text-sm">
        ...
        <tfoot class="bg-carbon font-bold text-slate-800 border-t border-carbonSoft">
          <tr>
            ...
            <td class="px-4 py-4 text-right text-success">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</td>
            <td class="px-4 py-4 text-right text-danger">Rp {{ number_format($totalCogs, 0, ',', '.') }}</td>
            <td class="px-4 py-4 text-right text-slate-800 text-base">Rp {{ number_format($grossProfit, 2, ',', '.') }}</td>
          </tr>
        </tfoot>
      </table>
    </div>
