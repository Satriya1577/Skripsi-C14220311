          ...
          <div class="w-full md:w-1/3">
            ...
            <div class="relative">
              <input type="number" name="qty_produced" placeholder="{{ max(0, $remainingBatchQty ?? 0) }}" min="1" required 
                class="block w-full p-3 bg-carbon border border-muted/30 rounded-lg text-slate-800 focus:ring-1 focus:ring-petronas focus:border-petronas pr-12 transition">
        ...
        <tbody class="divide-y divide-carbon/50">
          @forelse ($realizations as $index => $rz)
            <tr class="hover:bg-carbon/40 transition-colors group">
              ...
              <td class="px-4 py-4 text-right font-bold text-slate-800 text-base">
