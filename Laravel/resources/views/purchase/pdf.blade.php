  ...
  <div class="clearfix">
    <div class="totals">
      <div class="totals-row">
        ...
        <span class=" totals-value">Rp {{ number_format($purchaseOrder->items->sum('subtotal'), 2, ',', '.') }}</span>
      </div>
      ...
      <div class="totals-row grand-total">
        ...
        <span class=" totals-value">Rp {{ number_format($purchaseOrder->grand_total, 2, ',', '.') }}</span>
      </div>
    </div>
  </div>
