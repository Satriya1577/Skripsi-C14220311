  ...
  <header class="flex justify-between items-end">
    <div>
      <div class="flex items-center gap-3">
        ...
        @php
          $payColor = match($purchaseOrder->payment_status) {
        ...
        @endphp
        <span class="px-2 py-0.5 rounded text-[10px] uppercase font-bold border {{ $payColor }}">
  ...
  <section class="bg-carbonSoft rounded-xl p-6 border border-carbon">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
      ...
      <div class="bg-carbon rounded-lg p-4 border border-carbonSoft">
        ...
        <p class=" text-xl font-bold text-silver">Rp {{ number_format($purchaseOrder->grand_total, 2, ',', '.') }}</p>
      </div>
