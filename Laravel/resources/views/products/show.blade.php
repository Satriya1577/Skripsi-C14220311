      ...
      <form action="{{ route('product_materials.store', $product->id) }}" method="POST">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-end">
          ...
          <div class="w-full md:w-1/4">
            ...
            <div class="relative">
              <input type="number" step="0.001" name="amount_needed" placeholder="0.00" required class="block w-full p-3 bg-carbon border border-muted/30 rounded-lg text-slate-800 focus:ring-1 focus:ring-petronas focus:border-petronas pr-12">
        ...
        <tbody class="divide-y divide-carbon/50">
          @forelse ($product->productMaterials as $pm)
            <tr class="hover:bg-carbon transition-colors group">
              <td class="px-4 py-3 text-slate-800">{{ $pm->material->code }}</td>
